...
var outputCollection = 'users/your_username/MAPBIOMAS/C5/FOREST_PLANTATION/RESULTS/RAW';
...
var referenceCollection = ee.ImageCollection("users/your_username/MAPBIOMAS/C5/FOREST_PLANTATION/REFERENCE_MAP");
...
years.forEach(function(year){
  tiles.forEach(function(wrs){
    ...
    var train = mosaic.addBands(reference.select([0], ["class"]));
